(function () {
    ...
    function getColumnsForScaffolding(data) {
        ...
        for (var propertyName in data[0]) {
            columns.push({ headerText: propertyName, rowText: propertyName, sortColumnName: propertyName });
        }
        return columns;
    }
                    ...
                    <table class=\"ko-grid\" cellspacing=\"0\">\
                        <thead>\
                            <tr data-bind=\"foreach: columns\">\
                               <th data-bind=\"text: headerText, attr: { sortname: sortColumnName } \" class='sortableHead'></th>\
                            </tr>\
                        </thead>\
                        <tbody data-bind=\"foreach: itemsOnCurrentPage\">\
                           <tr data-bind=\"foreach: $parent.columns\">\
                               <!-- <td data-bind=\"text: typeof rowText == 'function' ? rowText($parent) : $parent[rowText] \"></td>-->\
                               <td \"><div data-bind=\"html: typeof rowText == 'function' ? rowText($parent) : $parent[rowText]  \"></div></td>\
                        </tr>\
                        </tbody>\
                    </table>");
